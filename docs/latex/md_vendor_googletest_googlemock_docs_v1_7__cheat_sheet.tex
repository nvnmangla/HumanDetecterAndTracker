\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md489}{}\doxysection{Mocking a Normal Class}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md489}
Given 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md490}{}\doxysection{Mocking a Class Template}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md490}
To mock 
\begin{DoxyCode}{0}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md491}{}\doxysection{Specifying Calling Conventions for Mock Functions}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md491}
...
where {\ttfamily S\+T\+D\+M\+E\+T\+H\+O\+D\+C\+A\+L\+L\+T\+Y\+PE} is defined by {\ttfamily $<$objbase.\+h$>$} on Windows.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md492}{}\doxysection{Using Mocks in Tests}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md492}
The typical flow is\+:
\begin{DoxyEnumerate}
...
\DoxyCodeLine{\}                                                 // \#6}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md493}{}\doxysection{Setting Default Actions}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md493}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md494}{}\doxysection{Setting Expectations}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md494}
...
A method with no {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} is free to be invoked {\itshape any number of times}, and the default action will be taken each time.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md495}{}\doxysection{Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md495}
...
Built-\/in matchers (where {\ttfamily argument} is the function argument) are divided into several categories\+:\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md496}{}\doxysubsection{Wildcard}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md496}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md497}{}\doxysubsection{Generic Comparison}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md497}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md499}{}\doxysubsection{String Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md499}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} use the regular expression syntax defined \href{http://code.google.com/p/googletest/wiki/AdvancedGuide\#Regular_Expression_Syntax}{\texttt{ here}}. {\ttfamily Str\+Case\+Eq()}, {\ttfamily Str\+Case\+Ne()}, {\ttfamily Str\+Eq()}, and {\ttfamily Str\+Ne()} work for wide strings as well.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md500}{}\doxysubsection{Container Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md500}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md501}{}\doxysubsection{Member Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md501}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md502}{}\doxysubsection{Matching the Result of a Function or Functor}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md502}
$\vert${\ttfamily Result\+Of(f, m)}$\vert${\ttfamily f(argument)} matches matcher {\ttfamily m}, where {\ttfamily f} is a function or functor.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md503}{}\doxysubsection{Pointer Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md503}
$\vert${\ttfamily Pointee(m)}$\vert${\ttfamily argument} (either a smart pointer or a raw pointer) points to a value that matches matcher {\ttfamily m}.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md504}{}\doxysubsection{Multiargument Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md504}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md505}{}\doxysubsection{Composite Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md505}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md506}{}\doxysubsection{Adapters for Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md506}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md507}{}\doxysubsection{Matchers as Predicates}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md507}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md508}{}\doxysubsection{Defining Matchers}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md508}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md509}{}\doxysubsection{Matchers as Test Assertions}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md509}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md510}{}\doxysection{Actions}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md510}
{\bfseries{Actions}} specify what a mock function should do when invoked.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md511}{}\doxysubsection{Returning a Value}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md511}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md512}{}\doxysubsection{Side Effects}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md512}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md513}{}\doxysubsection{Using a Function or a Functor as an Action}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md513}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md514}{}\doxysubsection{Default Action}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md514}
...
{\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md515}{}\doxysubsection{Composite Actions}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md515}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md516}{}\doxysubsection{Defining Actions}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md516}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
The {\ttfamily A\+C\+T\+I\+O\+N$\ast$} macros cannot be used inside a function or class.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md517}{}\doxysection{Cardinalities}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md517}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md518}{}\doxysection{Expectation Order}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md518}
By default, the expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, there are two ways to specify it. They can be used either independently or together.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md519}{}\doxysubsection{The After Clause}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md519}
...
says that all expected calls in the scope of {\ttfamily dummy} must occur in strict order. The name {\ttfamily dummy} is irrelevant.)\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md521}{}\doxysection{Verifying and Resetting a Mock}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md521}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md522}{}\doxysection{Mock Classes}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md522}
...
See this \href{http://code.google.com/p/googlemock/wiki/V1_7_CookBook\#Using_Check_Points}{\texttt{ recipe}} for one application of it.\hypertarget{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md523}{}\doxysection{Flags}\label{md_vendor_googletest_googlemock_docs_v1_7__cheat_sheet_autotoc_md523}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
