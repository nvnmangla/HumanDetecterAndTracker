\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md340}{}\doxysection{Mocking a Normal Class}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md340}
Given 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md341}{}\doxysection{Mocking a Class Template}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md341}
To mock 
\begin{DoxyCode}{0}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md342}{}\doxysection{Specifying Calling Conventions for Mock Functions}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md342}
...
where {\ttfamily S\+T\+D\+M\+E\+T\+H\+O\+D\+C\+A\+L\+L\+T\+Y\+PE} is defined by {\ttfamily $<$objbase.\+h$>$} on Windows.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md343}{}\doxysection{Using Mocks in Tests}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md343}
The typical flow is\+:
\begin{DoxyEnumerate}
...
\DoxyCodeLine{\}                                                 // \#6}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md344}{}\doxysection{Setting Default Actions}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md344}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md345}{}\doxysection{Setting Expectations}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md345}
...
A method with no {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} is free to be invoked {\itshape any number of times}, and the default action will be taken each time.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md346}{}\doxysection{Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md346}
...
Built-\/in matchers (where {\ttfamily argument} is the function argument) are divided into several categories\+:\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md347}{}\doxysubsection{Wildcard}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md347}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md348}{}\doxysubsection{Generic Comparison}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md348}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
These matchers use U\+L\+P-\/based comparison (the same as used in \href{http://code.google.com/p/googletest/}{\texttt{ Google Test}}). They automatically pick a reasonable error bound based on the absolute value of the expected value. {\ttfamily Double\+Eq()} and {\ttfamily Float\+Eq()} conform to the I\+E\+EE standard, which requires comparing two Na\+Ns for equality to return false. The {\ttfamily Nan\+Sensitive$\ast$} version instead treats two Na\+Ns as equal, which is often what a user wants.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md350}{}\doxysubsection{String Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md350}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} use the regular expression syntax defined \href{http://code.google.com/p/googletest/wiki/V1_6_AdvancedGuide\#Regular_Expression_Syntax}{\texttt{ here}}. {\ttfamily Str\+Case\+Eq()}, {\ttfamily Str\+Case\+Ne()}, {\ttfamily Str\+Eq()}, and {\ttfamily Str\+Ne()} work for wide strings as well.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md351}{}\doxysubsection{Container Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md351}
...
where the array may be multi-\/dimensional (i.\+e. its elements can be arrays).\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md352}{}\doxysubsection{Member Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md352}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md353}{}\doxysubsection{Matching the Result of a Function or Functor}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md353}
$\vert${\ttfamily Result\+Of(f, m)}$\vert${\ttfamily f(argument)} matches matcher {\ttfamily m}, where {\ttfamily f} is a function or functor.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md354}{}\doxysubsection{Pointer Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md354}
$\vert${\ttfamily Pointee(m)}$\vert${\ttfamily argument} (either a smart pointer or a raw pointer) points to a value that matches matcher {\ttfamily m}.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md355}{}\doxysubsection{Multiargument Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md355}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md356}{}\doxysubsection{Composite Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md356}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md357}{}\doxysubsection{Adapters for Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md357}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md358}{}\doxysubsection{Matchers as Predicates}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md358}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md359}{}\doxysubsection{Defining Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md359}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md360}{}\doxysubsection{Matchers as Test Assertions}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md360}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md361}{}\doxysection{Actions}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md361}
{\bfseries{Actions}} specify what a mock function should do when invoked.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md362}{}\doxysubsection{Returning a Value}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md362}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md363}{}\doxysubsection{Side Effects}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md363}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md364}{}\doxysubsection{Using a Function or a Functor as an Action}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md364}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md365}{}\doxysubsection{Default Action}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md365}
...
{\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md366}{}\doxysubsection{Composite Actions}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md366}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md367}{}\doxysubsection{Defining Actions}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md367}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
The {\ttfamily A\+C\+T\+I\+O\+N$\ast$} macros cannot be used inside a function or class.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md368}{}\doxysection{Cardinalities}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md368}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md369}{}\doxysection{Expectation Order}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md369}
By default, the expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, there are two ways to specify it. They can be used either independently or together.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md370}{}\doxysubsection{The After Clause}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md370}
...
says that all expected calls in the scope of {\ttfamily dummy} must occur in strict order. The name {\ttfamily dummy} is irrelevant.)\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md372}{}\doxysection{Verifying and Resetting a Mock}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md372}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md373}{}\doxysection{Mock Classes}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md373}
...
See this \href{http://code.google.com/p/googlemock/wiki/V1_6_CookBook\#Using_Check_Points}{\texttt{ recipe}} for one application of it.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md374}{}\doxysection{Flags}\label{md_vendor_googletest_googlemock_docs_v1_6__cheat_sheet_autotoc_md374}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
