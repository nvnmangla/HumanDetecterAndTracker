Now that you have read Primer and learned how to write tests using Google Test, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1083}{}\doxysection{More Assertions}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1083}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1084}{}\doxysubsection{Explicit Success and Failure}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1084}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1085}{}\doxysubsection{Exception Assertions}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1085}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1086}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1086}
...
Google Test gives you three different options to solve this problem\+:\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1087}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1087}
...
{\itshape Availability}\+: Linux, Windows, Mac\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1088}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1088}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+4.\+1.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1089}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1089}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1090}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1090}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1092}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1092}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1093}{}\doxysubsection{Windows H\+R\+E\+S\+U\+L\+T assertions}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1093}
...
{\itshape Availability}\+: Windows.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1094}{}\doxysubsection{Type Assertions}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1094}
...
{\itshape Availability\+:} Linux, Windows, Mac; since version 1.\+3.\+0.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1095}{}\doxysubsection{Assertion Placement}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1095}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1097}{}\doxysection{Death Tests}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1097}
...
If you want to test {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$()/\+A\+S\+S\+E\+R\+T\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ Catching Failures}}.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1098}{}\doxysubsection{How to Write a Death Test}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1098}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Cygwin, and Mac (the latter three are supported since v1.\+3.\+0). {\ttfamily (A\+S\+S\+E\+R\+T$\vert$\+E\+X\+P\+E\+CT)\+\_\+\+D\+E\+A\+T\+H\+\_\+\+I\+F\+\_\+\+S\+U\+P\+P\+O\+R\+T\+ED} are new in v1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1099}{}\doxysubsection{Regular Expression Syntax}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1099}
...
If the death test statement runs to completion without dying, the child process will nonetheless terminate, and the assertion fails.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1101}{}\doxysubsection{Death Tests And Threads}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1101}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1102}{}\doxysubsection{Death Test Styles}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1102}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1103}{}\doxysubsection{Caveats}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1103}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1104}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1104}
\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1105}{}\doxysubsection{Adding Traces to Assertions}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1105}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1106}{}\doxysubsection{Propagating Fatal Failures}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1106}
...
{\itshape Availability\+:} Linux, Windows, Mac. Assertions from multiple threads are currently not supported.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1108}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1108}
...
{\itshape Availability\+:} Linux, Windows, Mac. {\ttfamily Has\+Nonfatal\+Failure()} and {\ttfamily Has\+Failure()} are available since version 1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1109}{}\doxysection{Logging Additional Information}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1109}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1110}{}\doxysection{Sharing Resources Between Tests in the Same Test Case}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1110}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1111}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1111}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1112}{}\doxysection{Value Parameterized Tests}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1112}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1113}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1113}
...
{\itshape Availability}\+: Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+2.\+0.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1114}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1114}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily I\+N\+S\+T\+A\+N\+T\+I\+A\+T\+E\+\_\+\+T\+E\+S\+T\+\_\+\+C\+A\+S\+E\+\_\+\+P()}, and linking with {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test case multiple times, possibly in different source files.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1115}{}\doxysection{Typed Tests}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1115}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1116}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1116}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1117}{}\doxysection{Testing Private Code}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1117}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1118}{}\doxysubsection{Static Functions}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1118}
...
However, a better approach is to move the private code into the {\ttfamily foo\+::internal} namespace, where {\ttfamily foo} is the namespace your project normally uses, and put the private declarations in a {\ttfamily $\ast$-\/internal.h} file. Your production {\ttfamily .cc} files and your tests are allowed to include this internal header, but your clients are not. This way, you can fully test your internal implementation without leaking it to your clients.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1119}{}\doxysubsection{Private Class Members}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1119}
...
\DoxyCodeLine{\}  // namespace my\_namespace}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1120}{}\doxysection{Catching Failures}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1120}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1121}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1121}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1122}{}\doxysection{Extending Google Test by Handling Test Events}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1122}
...
{\itshape Availability\+:} Linux, Windows, Mac; since v1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1123}{}\doxysubsection{Defining Event Listeners}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1123}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1124}{}\doxysubsection{Using Event Listeners}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1124}
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default X\+ML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1125}{}\doxysubsection{Generating Failures in Listeners}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1125}
...
We have a sample of failure-\/raising listener \href{../samples/sample10_unittest.cc}{\texttt{ here}}.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1126}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1126}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1127}{}\doxysubsection{Selecting Tests}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1127}
This section shows various options for choosing which tests to run.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1128}{}\doxysubsubsection{Listing Test Names}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1128}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1129}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1129}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1130}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1130}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1131}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1131}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1132}{}\doxysubsection{Repeating the Tests}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1132}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1133}{}\doxysubsection{Shuffling the Tests}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1133}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1134}{}\doxysubsection{Controlling Test Output}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1134}
{\itshape  This section teaches how to tweak the way test results are reported.}

{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1135}{}\doxysubsubsection{Colored Terminal Output}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1135}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1136}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1136}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1137}{}\doxysubsubsection{Generating an X\+M\+L Report}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1137}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1138}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1138}
{\itshape  }\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1139}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1139}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1140}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1140}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1141}{}\doxysubsubsection{Letting Another Testing Framework Drive}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1141}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1142}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1142}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1143}{}\doxysection{Fusing Google Test Source Files}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1143}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1144}{}\doxysection{Where to Go from Here}\label{md_vendor_googletest_googletest_docs__v1_7__advanced_guide_autotoc_md1144}
