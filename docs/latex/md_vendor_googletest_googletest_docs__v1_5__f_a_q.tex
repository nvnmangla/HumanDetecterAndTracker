If you cannot find the answer to your question here, and you have read Primer and Advanced\+Guide, send it to \href{mailto:googletestframework@googlegroups.com}{\texttt{ googletestframework@googlegroups.\+com}}.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md873}{}\doxysubsection{Why should I use Google Test instead of my favorite C++ testing framework?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md873}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md874}{}\doxysubsection{How do I generate 64-\/bit binaries on Windows (using Visual Studio 2008)?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md874}
...
In order to prevent build output files from overwriting one another, you\textquotesingle{}ll need to change the {\ttfamily Intermediate Directory} settings for the newly created platform configuration across all the projects. To do this, multi-\/select (e.\+g. using shift-\/click) all projects (but not the solution) in the {\ttfamily Solution Explorer}. Right-\/click one of them and select {\ttfamily Properties}. In the left pane, select {\ttfamily Configuration Properties}, and from the {\ttfamily Configuration} dropdown, select {\ttfamily All Configurations}. Make sure the selected platform is {\ttfamily x64}. For the {\ttfamily Intermediate Directory} setting, change the value from {\ttfamily \textbackslash{}} to {\ttfamily \textbackslash{}}. Click {\ttfamily OK} and then build the solution. When the build is complete, the 64-\/bit binaries will be in the {\ttfamily msvc\textbackslash{}x64\textbackslash{}Debug} directory.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md875}{}\doxysubsection{Can I use Google Test on Min\+G\+W?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md875}
...
Please contact {\ttfamily googletestframework@googlegroups.\+com} if you are interested in improving the support for Min\+GW.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md876}{}\doxysubsection{Why does Google Test support E\+X\+P\+E\+C\+T\+\_\+\+E\+Q(\+N\+U\+L\+L, ptr) and A\+S\+S\+E\+R\+T\+\_\+\+E\+Q(\+N\+U\+L\+L, ptr) but not E\+X\+P\+E\+C\+T\+\_\+\+N\+E(\+N\+U\+L\+L, ptr) and A\+S\+S\+E\+R\+T\+\_\+\+N\+E(\+N\+U\+L\+L, ptr)?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md876}
...
Finally, with the growth of Google \mbox{\hyperlink{class_mock}{Mock}}\textquotesingle{}s \href{../../CookBook.md\#using-matchers-in-google-test-assertions}{\texttt{ matcher}} library, we are encouraging people to use the unified {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+T\+H\+A\+T(value, matcher)} syntax more often in tests. One significant advantage of the matcher approach is that matchers can be easily combined to form new matchers, while the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+NE}, etc, macros cannot be easily combined. Therefore we want to invest more in the matchers than in the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+X\+X()} macros.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md877}{}\doxysubsection{Does Google Test support running tests in parallel?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md877}
Test runners tend to be tightly coupled with the build/test environment, and Google Test doesn\textquotesingle{}t try to solve the problem of running tests in parallel. Instead, we tried to make Google Test work nicely with test runners. For example, Google Test\textquotesingle{}s X\+ML report contains the time spent on each test, and its {\ttfamily gtest\+\_\+list\+\_\+tests} and {\ttfamily gtest\+\_\+filter} flags can be used for splitting the execution of test methods into multiple processes. These functionalities can help the test runner run the tests in parallel.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md878}{}\doxysubsection{Why don\textquotesingle{}t Google Test run the tests in different threads to speed things up?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md878}
...
If you think about it, it\textquotesingle{}s already hard to make your code work when you know what other threads are doing. It\textquotesingle{}s much harder, and sometimes even impossible, to make your code work when you don\textquotesingle{}t know what other threads are doing (remember that test methods can be added, deleted, or modified after your test was written). If you want to run the tests in parallel, you\textquotesingle{}d better run them in different processes.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md879}{}\doxysubsection{Why aren\textquotesingle{}t Google Test assertions implemented using exceptions?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md879}
...
The downside of not using exceptions is that {\ttfamily A\+S\+S\+E\+R\+T\+\_\+$\ast$} (implemented using {\ttfamily return}) will only abort the current function, not the current {\ttfamily T\+E\+ST}.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md880}{}\doxysubsection{Why do we use two different macros for tests with and without fixtures?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md880}
...
We think neither approach is ideal, yet either of them is reasonable. In the end, it probably doesn\textquotesingle{}t matter much either way.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md881}{}\doxysubsection{Why don\textquotesingle{}t we use structs as test fixtures?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md881}
We like to use structs only when representing passive data. This distinction between structs and classes is good for documenting the intent of the code\textquotesingle{}s author. Since test fixtures have logic like {\ttfamily Set\+Up()} and {\ttfamily Tear\+Down()}, they are better defined as classes.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md882}{}\doxysubsection{Why are death tests implemented as assertions instead of using a test runner?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md882}
...
Another interesting thing about {\ttfamily A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+TH} is that it calls {\ttfamily fork()} to create a child process to run the death test. This is lightening fast, as {\ttfamily fork()} uses copy-\/on-\/write pages and incurs almost zero overhead, and the child process starts from the user-\/supplied statement directly, skipping all global and local initialization and any code leading to the given statement. If you launch the child process from scratch, it can take seconds just to load everything and start running if the test links to many libraries dynamically.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md883}{}\doxysubsection{My death test modifies some state, but the change seems lost after the death test finishes. Why?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md883}
Death tests ({\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+D\+E\+A\+TH}, etc) are executed in a sub-\/process s.\+t. the expected crash won\textquotesingle{}t kill the test program (i.\+e. the parent process). As a result, any in-\/memory side effects they incur are observable in their respective sub-\/processes, but not in the parent process. You can think of them as running in a parallel universe, more or less.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md884}{}\doxysubsection{The compiler complains about \char`\"{}undefined references\char`\"{} to some static const member variables, but I did define them in the class body. What\textquotesingle{}s wrong?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md884}
...
Otherwise your code is {\bfseries{invalid C++}}, and may break in unexpected ways. In particular, using it in Google Test comparison assertions ({\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+EQ}, etc) will generate an \char`\"{}undefined reference\char`\"{} linker error.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md885}{}\doxysubsection{I have an interface that has several implementations. Can I write a set of tests once and repeat them over all the implementations?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md885}
Google Test doesn\textquotesingle{}t yet have good support for this kind of tests, or data-\/driven tests in general. We hope to be able to make improvements in this area soon.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md886}{}\doxysubsection{Can I derive a test fixture from another?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md886}
Yes.
...
For a complete example using derived test fixtures, see {\ttfamily \mbox{\hyperlink{sample5__unittest_8cc_source}{samples/sample5\+\_\+unittest.\+cc}}}.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md887}{}\doxysubsection{My compiler complains \char`\"{}void value not ignored as it ought to be.\char`\"{} What does this mean?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md887}
You\textquotesingle{}re probably using an {\ttfamily A\+S\+S\+E\+R\+T\+\_\+$\ast$()} in a function that doesn\textquotesingle{}t return {\ttfamily void}. {\ttfamily A\+S\+S\+E\+R\+T\+\_\+$\ast$()} can only be used in {\ttfamily void} functions.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md888}{}\doxysubsection{My death test hangs (or seg-\/faults). How do I fix it?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md888}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md890}{}\doxysubsection{The compiler complains \char`\"{}no matching function to call\char`\"{} when I use A\+S\+S\+E\+R\+T\+\_\+\+P\+R\+E\+Dn. How do I fix it?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md890}
...
\DoxyCodeLine{ASSERT\_PRED2(*(GreaterThan<int, int>)*, 5, 0);}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md891}{}\doxysubsection{My compiler complains about \char`\"{}ignoring return value\char`\"{} when I call R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S(). Why?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md891}
...
To help the users avoid this dangerous bug, the implementation of {\ttfamily R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S()} causes gcc to raise this warning, when the return value is ignored. If you see this warning, the fix is simple\+: just make sure its value is used as the return value of {\ttfamily main()}.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md892}{}\doxysubsection{My compiler complains that a constructor (or destructor) cannot return a value. What\textquotesingle{}s going on?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md892}
...
we had to give up using {\ttfamily A\+S\+S\+E\+R\+T$\ast$} and {\ttfamily F\+A\+I\+L$\ast$} (but not {\ttfamily E\+X\+P\+E\+C\+T$\ast$} and {\ttfamily A\+D\+D\+\_\+\+F\+A\+I\+L\+U\+R\+E$\ast$}) in constructors and destructors. The workaround is to move the content of your constructor/destructor to a private void member function, or switch to {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$()} if that works. This section in the user\textquotesingle{}s guide explains it.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md893}{}\doxysubsection{My set-\/up function is not called. Why?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md893}
C++ is case-\/sensitive. It should be spelled as {\ttfamily Set\+Up()}. Did you spell it as {\ttfamily Setup()}?

Similarly, sometimes people spell {\ttfamily Set\+Up\+Test\+Case()} as {\ttfamily Setup\+Test\+Case()} and wonder why it\textquotesingle{}s never called.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md894}{}\doxysubsection{How do I jump to the line of a failure in Emacs directly?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md894}
Google Test\textquotesingle{}s failure message format is understood by Emacs and many other I\+D\+Es, like acme and X\+Code. If a Google Test message is in a compilation buffer in Emacs, then it\textquotesingle{}s clickable. You can now hit {\ttfamily enter} on a message to jump to the corresponding source code, or use {\ttfamily C-\/x}\`{} to jump to the next failure.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md895}{}\doxysubsection{I have several test cases which share the same test fixture logic, do I have to define a new test fixture class for each of them? This seems pretty tedious.}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md895}
...
\DoxyCodeLine{TEST\_F(BarTest, Def) \{ ... \}}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md896}{}\doxysubsection{The Google Test output is buried in a whole bunch of log messages. What do I do?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md896}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md897}{}\doxysubsection{Why should I prefer test fixtures over global variables?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md897}
...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md898}{}\doxysubsection{How do I test private class members without writing F\+R\+I\+E\+N\+D\+\_\+\+T\+E\+S\+T()s?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md898}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md899}{}\doxysubsection{How do I test private class static members without writing F\+R\+I\+E\+N\+D\+\_\+\+T\+E\+S\+T()s?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md899}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md900}{}\doxysubsection{I would like to run a test several times with different parameters. Do I need to write several similar copies of it?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md900}
No. You can use a feature called \href{V1_5_AdvancedGuide.md\#Value_Parameterized_Tests}{\texttt{ value-\/parameterized tests}} which lets you repeat your tests with different parameters, without defining it more than once.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md901}{}\doxysubsection{How do I test a file that defines main()?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md901}
...
However, please remember this is a hack and should only be used as the last resort.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md902}{}\doxysubsection{What can the statement argument in A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+T\+H() be?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md902}
...
{\ttfamily googletest\+\_\+unittest.\+cc} contains more examples if you are interested.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md903}{}\doxysubsection{What syntax does the regular expression in A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+T\+H use?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md903}
On P\+O\+S\+IX systems, Google Test uses the P\+O\+S\+IX Extended regular expression syntax (\href{http://en.wikipedia.org/wiki/Regular_expression\#POSIX_Extended_Regular_Expressions}{\texttt{ http\+://en.\+wikipedia.\+org/wiki/\+Regular\+\_\+expression\#\+P\+O\+S\+I\+X\+\_\+\+Extended\+\_\+\+Regular\+\_\+\+Expressions}}). On Windows, it uses a limited variant of regular expression syntax. For more details, see the \href{V1_5_AdvancedGuide.md\#Regular_Expression_Syntax}{\texttt{ regular expression syntax}}.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md904}{}\doxysubsection{I have a fixture class Foo, but T\+E\+S\+T\+\_\+\+F(\+Foo, Bar) gives me error \char`\"{}no matching function for call to Foo\+::\+Foo()\char`\"{}. Why?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md904}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md905}{}\doxysubsection{Why does A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+T\+H complain about previous threads that were already joined?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md905}
...
The new N\+P\+TL thread library doesn\textquotesingle{}t suffer from this problem, as it doesn\textquotesingle{}t create a manager thread. However, if you don\textquotesingle{}t control which machine your test runs on, you shouldn\textquotesingle{}t depend on this.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md906}{}\doxysubsection{Why does Google Test require the entire test case, instead of individual tests, to be named F\+O\+O\+Death\+Test when it uses A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+T\+H?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md906}
...
Since {\ttfamily Foo\+Test.\+Abc\+Death\+Test} needs to run before {\ttfamily Bar\+Test.\+Xyz}, and we don\textquotesingle{}t interleave tests from different test cases, we need to run all tests in the {\ttfamily \mbox{\hyperlink{class_foo_test}{Foo\+Test}}} case before running any test in the {\ttfamily Bar\+Test} case. This contradicts with the requirement to run {\ttfamily Bar\+Test.\+Def\+Death\+Test} before {\ttfamily Foo\+Test.\+Uvw}.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md907}{}\doxysubsection{But I don\textquotesingle{}t like calling my entire test case F\+O\+O\+Death\+Test when it contains both death tests and non-\/death tests. What do I do?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md907}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md908}{}\doxysubsection{The compiler complains about \char`\"{}no match for \textquotesingle{}operator$<$$<$\textquotesingle{}\char`\"{} when I use an assertion. What gives?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md908}
...
In addition, if {\ttfamily Foo\+Type} is declared in a name space, the {\ttfamily $<$$<$} operator also needs to be defined in the {\itshape same} name space.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md909}{}\doxysubsection{How do I suppress the memory leak messages on Windows?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md909}
Since the statically initialized Google Test singleton requires allocations on the heap, the Visual C++ memory leak detector will report memory leaks at the end of the program run. The easiest way to avoid this is to use the {\ttfamily \+\_\+\+Crt\+Mem\+Checkpoint} and {\ttfamily \+\_\+\+Crt\+Mem\+Dump\+All\+Objects\+Since} calls to not report any statically initialized heap objects. See M\+S\+DN for more details and additional heap check/debug routines.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md910}{}\doxysubsection{I am building my project with Google Test in Visual Studio and all I\textquotesingle{}m getting is a bunch of linker errors (or warnings). Help!}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md910}
...
To update this setting open the project properties in the Visual Studio I\+DE then select the branch Configuration Properties $\vert$ C/\+C++ $\vert$ Code Generation and change the option \char`\"{}\+Runtime Library\char`\"{}. You may also try using gtest-\/md.\+vcproj instead of gtest.\+vcproj.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md911}{}\doxysubsection{I put my tests in a library and Google Test doesn\textquotesingle{}t run them. What\textquotesingle{}s happening?}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md911}
Have you read a \href{V1_5_Primer.md\#important-note-for-visual-c-users}{\texttt{ warning}} on the Google Test Primer page?\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md912}{}\doxysubsection{I want to use Google Test with Visual Studio but don\textquotesingle{}t know where to start.}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md912}
Many people are in your position and one of the posted his solution to our mailing list. Here is his link\+: \href{http://hassanjamilahmad.blogspot.com/2009/07/gtest-starters-help.html}{\texttt{ http\+://hassanjamilahmad.\+blogspot.\+com/2009/07/gtest-\/starters-\/help.\+html}}.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md913}{}\doxysubsection{My question is not covered in your F\+A\+Q!}\label{md_vendor_googletest_googletest_docs__v1_5__f_a_q_autotoc_md913}
