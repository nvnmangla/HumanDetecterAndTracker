This guide will explain how to use the Google Testing Framework in your Xcode projects on Mac OS X. This tutorial begins by quickly explaining what to do for experienced users. After the quick start, the guide goes provides additional explanation about each step.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__xcode_guide_autotoc_md1217}{}\doxysection{Quick Start}\label{md_vendor_googletest_googletest_docs__v1_7__xcode_guide_autotoc_md1217}
...
The following sections further explain each of the steps listed above in depth, describing in more detail how to complete it including some variations.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__xcode_guide_autotoc_md1218}{}\doxysection{Get the Source}\label{md_vendor_googletest_googletest_docs__v1_7__xcode_guide_autotoc_md1218}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_7__xcode_guide_autotoc_md1219}{}\doxysection{Add the Framework to Your Project}\label{md_vendor_googletest_googletest_docs__v1_7__xcode_guide_autotoc_md1219}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_7__xcode_guide_autotoc_md1220}{}\doxysection{Make a Test Target}\label{md_vendor_googletest_googletest_docs__v1_7__xcode_guide_autotoc_md1220}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_7__xcode_guide_autotoc_md1221}{}\doxysection{Set Up the Executable Run Environment}\label{md_vendor_googletest_googletest_docs__v1_7__xcode_guide_autotoc_md1221}
...
To correct this problem, got to the directory containing the executable named in \char`\"{}\+Referenced from\+:\char`\"{} value in the error message above. Then, with the terminal in this location, find the relative path to the directory containing the gtest.\+framework. That is the value you\textquotesingle{}ll need to set as the D\+Y\+L\+D\+\_\+\+F\+R\+A\+M\+E\+W\+O\+R\+K\+\_\+\+P\+A\+TH.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__xcode_guide_autotoc_md1222}{}\doxysection{Build and Go}\label{md_vendor_googletest_googletest_docs__v1_7__xcode_guide_autotoc_md1222}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_7__xcode_guide_autotoc_md1223}{}\doxysection{Summary}\label{md_vendor_googletest_googletest_docs__v1_7__xcode_guide_autotoc_md1223}
