\hypertarget{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1232}{}\doxysubsubsection{Setup}\label{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1232}
To build Google Test and your tests that use it, you need to tell your build system where to find its headers and source files. The exact way to do it depends on which build system you use, and is usually straightforward.\hypertarget{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1233}{}\doxysubsubsection{Build}\label{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1233}
...
If you see errors, try to tweak the contents of {\ttfamily make/\+Makefile} to make them go away. There are instructions in {\ttfamily make/\+Makefile} on how to do it.\hypertarget{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1234}{}\doxysubsection{Using C\+Make}\label{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1234}
...
On Mac OS X with Xcode installed, a {\ttfamily .xcodeproj} file will be generated.\hypertarget{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1235}{}\doxysubsection{Legacy Build Scripts}\label{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1235}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1236}{}\doxysubsection{Tweaking Google Test}\label{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1236}
...
We list the most frequently used macros below. For a complete list, see file \href{include/gtest/internal/gtest-port.h}{\texttt{ include/gtest/internal/gtest-\/port.\+h}}.\hypertarget{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1237}{}\doxysubsection{Choosing a T\+R1 Tuple Library}\label{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1237}
...
and all features using tuple will be disabled.\hypertarget{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1238}{}\doxysubsection{Multi-\/threaded Tests}\label{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1238}
...
Note\+: while the above steps aren\textquotesingle{}t technically necessary today when using some compilers (e.\+g. G\+CC), they may become necessary in the future, if we decide to improve the speed of loading the library (see \href{http://gcc.gnu.org/wiki/Visibility}{\texttt{ http\+://gcc.\+gnu.\+org/wiki/\+Visibility}} for details). Therefore you are recommended to always add the above flags when using Google Test as a shared library. Otherwise a future release of Google Test may break your build script.\hypertarget{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1240}{}\doxysubsection{Avoiding Macro Name Clashes}\label{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1240}
...
in order to define a test.\hypertarget{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1241}{}\doxysection{Developing Google Test}\label{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1241}
This section discusses how to make your own changes to Google Test.\hypertarget{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1242}{}\doxysubsection{Testing Google Test Itself}\label{md_vendor_googletest_googletest__r_e_a_d_m_e_autotoc_md1242}
