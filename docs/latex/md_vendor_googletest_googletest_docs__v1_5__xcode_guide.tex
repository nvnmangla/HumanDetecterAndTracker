This guide will explain how to use the Google Testing Framework in your Xcode projects on Mac OS X. This tutorial begins by quickly explaining what to do for experienced users. After the quick start, the guide goes provides additional explanation about each step.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__xcode_guide_autotoc_md937}{}\doxysection{Quick Start}\label{md_vendor_googletest_googletest_docs__v1_5__xcode_guide_autotoc_md937}
...
The following sections further explain each of the steps listed above in depth, describing in more detail how to complete it including some variations.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__xcode_guide_autotoc_md938}{}\doxysection{Get the Source}\label{md_vendor_googletest_googletest_docs__v1_5__xcode_guide_autotoc_md938}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_5__xcode_guide_autotoc_md939}{}\doxysection{Add the Framework to Your Project}\label{md_vendor_googletest_googletest_docs__v1_5__xcode_guide_autotoc_md939}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_5__xcode_guide_autotoc_md940}{}\doxysection{Make a Test Target}\label{md_vendor_googletest_googletest_docs__v1_5__xcode_guide_autotoc_md940}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_5__xcode_guide_autotoc_md941}{}\doxysection{Set Up the Executable Run Environment}\label{md_vendor_googletest_googletest_docs__v1_5__xcode_guide_autotoc_md941}
...
To correct this problem, got to the directory containing the executable named in \char`\"{}\+Referenced from\+:\char`\"{} value in the error message above. Then, with the terminal in this location, find the relative path to the directory containing the gtest.\+framework. That is the value you\textquotesingle{}ll need to set as the D\+Y\+L\+D\+\_\+\+F\+R\+A\+M\+E\+W\+O\+R\+K\+\_\+\+P\+A\+TH.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__xcode_guide_autotoc_md942}{}\doxysection{Build and Go}\label{md_vendor_googletest_googletest_docs__v1_5__xcode_guide_autotoc_md942}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_5__xcode_guide_autotoc_md943}{}\doxysection{Summary}\label{md_vendor_googletest_googletest_docs__v1_5__xcode_guide_autotoc_md943}
