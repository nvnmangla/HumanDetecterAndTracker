\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md194}{}\doxysection{Mocking a Normal Class}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md194}
Given 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md195}{}\doxysection{Mocking a Class Template}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md195}
To mock 
\begin{DoxyCode}{0}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md196}{}\doxysection{Specifying Calling Conventions for Mock Functions}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md196}
...
where {\ttfamily S\+T\+D\+M\+E\+T\+H\+O\+D\+C\+A\+L\+L\+T\+Y\+PE} is defined by {\ttfamily $<$objbase.\+h$>$} on Windows.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md197}{}\doxysection{Using Mocks in Tests}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md197}
The typical flow is\+:
\begin{DoxyEnumerate}
...
\DoxyCodeLine{\}                                                 // \#6}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md198}{}\doxysection{Setting Default Actions}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md198}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md199}{}\doxysection{Setting Expectations}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md199}
...
A method with no {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} is free to be invoked {\itshape any number of times}, and the default action will be taken each time.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md200}{}\doxysection{Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md200}
...
Built-\/in matchers (where {\ttfamily argument} is the function argument) are divided into several categories\+:\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md201}{}\doxysubsection{Wildcard}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md201}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md202}{}\doxysubsection{Generic Comparison}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md202}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
The above matchers use U\+L\+P-\/based comparison (the same as used in \href{http://code.google.com/p/googletest/}{\texttt{ Google Test}}). They automatically pick a reasonable error bound based on the absolute value of the expected value. {\ttfamily Double\+Eq()} and {\ttfamily Float\+Eq()} conform to the I\+E\+EE standard, which requires comparing two Na\+Ns for equality to return false. The {\ttfamily Nan\+Sensitive$\ast$} version instead treats two Na\+Ns as equal, which is often what a user wants.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md204}{}\doxysubsection{String Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md204}
...
{\ttfamily Str\+Case\+Eq()}, {\ttfamily Str\+Case\+Ne()}, {\ttfamily Str\+Eq()}, and {\ttfamily Str\+Ne()} work for wide strings as well.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md205}{}\doxysubsection{Container Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md205}
...
where the array may be multi-\/dimensional (i.\+e. its elements can be arrays).\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md206}{}\doxysubsection{Member Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md206}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md207}{}\doxysubsection{Matching the Result of a Function or Functor}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md207}
$\vert${\ttfamily Result\+Of(f, m)}$\vert${\ttfamily f(argument)} matches matcher {\ttfamily m}, where {\ttfamily f} is a function or functor.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md208}{}\doxysubsection{Pointer Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md208}
$\vert${\ttfamily Pointee(m)}$\vert${\ttfamily argument} (either a smart pointer or a raw pointer) points to a value that matches matcher {\ttfamily m}.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md209}{}\doxysubsection{Multiargument Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md209}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md210}{}\doxysubsection{Composite Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md210}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md211}{}\doxysubsection{Adapters for Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md211}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md212}{}\doxysubsection{Matchers as Predicates}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md212}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md213}{}\doxysubsection{Defining Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md213}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md214}{}\doxysubsection{Matchers as Test Assertions}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md214}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md215}{}\doxysection{Actions}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md215}
{\bfseries{Actions}} specify what a mock function should do when invoked.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md216}{}\doxysubsection{Returning a Value}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md216}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md217}{}\doxysubsection{Side Effects}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md217}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md218}{}\doxysubsection{Using a Function or a Functor as an Action}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md218}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md219}{}\doxysubsection{Default Action}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md219}
...
{\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md220}{}\doxysubsection{Composite Actions}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md220}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md221}{}\doxysubsection{Defining Actions}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md221}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
The {\ttfamily A\+C\+T\+I\+O\+N$\ast$} macros cannot be used inside a function or class.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md222}{}\doxysection{Cardinalities}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md222}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md223}{}\doxysection{Expectation Order}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md223}
By default, the expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, there are two ways to specify it. They can be used either independently or together.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md224}{}\doxysubsection{The After Clause}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md224}
...
Modifying an {\ttfamily Expectation\+Set} after using it in an {\ttfamily .After()} doesn\textquotesingle{}t affect the meaning of the {\ttfamily .After()}.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md225}{}\doxysubsection{Sequences}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md225}
...
says that all expected calls in the scope of {\ttfamily dummy} must occur in strict order. The name {\ttfamily dummy} is irrelevant.)\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md226}{}\doxysection{Verifying and Resetting a Mock}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md226}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md227}{}\doxysection{Mock Classes}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md227}
...
See this recipe for one application of it.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md228}{}\doxysection{Flags}\label{md_vendor_googletest_googlemock_docs_v1_5__cheat_sheet_autotoc_md228}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
