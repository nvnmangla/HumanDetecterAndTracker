{\bfseries{P}}ump is {\bfseries{U}}seful for {\bfseries{M}}eta {\bfseries{P}}rogramming.\hypertarget{md_vendor_googletest_googletest_docs__pump_manual_autotoc_md803}{}\doxysection{The Problem}\label{md_vendor_googletest_googletest_docs__pump_manual_autotoc_md803}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__pump_manual_autotoc_md806}{}\doxysubsection{Examples}\label{md_vendor_googletest_googletest_docs__pump_manual_autotoc_md806}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__pump_manual_autotoc_md807}{}\doxysubsection{Constructs}\label{md_vendor_googletest_googletest_docs__pump_manual_autotoc_md807}
...
{\bfseries{Note\+:}} To give the user some freedom in formatting the Pump source code, Pump ignores a new-\/line character if it\textquotesingle{}s right after {\ttfamily \$for foo} or next to {\ttfamily \mbox{[}\mbox{[}} or {\ttfamily \mbox{]}\mbox{]}}. Without this rule you\textquotesingle{}ll often be forced to write very long lines to get the desired output. Therefore sometimes you may need to insert an extra new-\/line in such places for a new-\/line to show up in your output.\hypertarget{md_vendor_googletest_googletest_docs__pump_manual_autotoc_md808}{}\doxysubsection{Grammar}\label{md_vendor_googletest_googletest_docs__pump_manual_autotoc_md808}
