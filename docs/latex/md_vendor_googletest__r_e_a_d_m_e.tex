...
More detailed documentation for googletest (including build instructions) are in its interior googletest/\+R\+E\+A\+D\+ME.md file.\hypertarget{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1245}{}\doxysection{Features}\label{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1245}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1246}{}\doxysection{Platforms}\label{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1246}
...
\item Windows Mobile
\item Symbian
\end{DoxyItemize}\hypertarget{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1247}{}\doxysection{Who Is Using Google Test?}\label{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1247}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1248}{}\doxysection{Related Open Source Projects}\label{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1248}
...
\href{https://github.com/kinow/gtest-tap-listener}{\texttt{ G\+Test T\+AP Listener}} is an event listener for Google Test that implements the \href{https://en.wikipedia.org/wiki/Test_Anything_Protocol}{\texttt{ T\+AP protocol}} for test result output. If your test runner understands T\+AP, you may find it useful.\hypertarget{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1249}{}\doxysection{Requirements}\label{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1249}
Google Test is designed to have fairly minimal requirements to build and use with your projects, but there are some. Currently, we support Linux, Windows, Mac OS X, and Cygwin. We will also make our best effort to support other platforms (e.\+g. Solaris, A\+IX, and z/\+OS). However, since core members of the Google Test project have no access to these platforms, Google Test may have outstanding issues there. If you notice any problems on your platform, please notify \href{mailto:googletestframework@googlegroups.com}{\texttt{ googletestframework@googlegroups.\+com}}. Patches for fixing them are even more welcome!\hypertarget{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1250}{}\doxysubsection{Linux Requirements}\label{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1250}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1251}{}\doxysubsection{Windows Requirements}\label{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1251}

\begin{DoxyItemize}
\item Microsoft Visual C++ v7.\+1 or newer
\end{DoxyItemize}\hypertarget{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1252}{}\doxysubsection{Cygwin Requirements}\label{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1252}

\begin{DoxyItemize}
\item Cygwin v1.\+5.\+25-\/14 or newer
\end{DoxyItemize}\hypertarget{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1253}{}\doxysubsection{Mac O\+S X Requirements}\label{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1253}

\begin{DoxyItemize}
\item Mac OS X v10.\+4 Tiger or newer
\item Xcode Developer Tools
\end{DoxyItemize}\hypertarget{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1254}{}\doxysubsection{Requirements for Contributors}\label{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1254}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1255}{}\doxysection{Regenerating Source Files}\label{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1255}
...
You don\textquotesingle{}t need to worry about regenerating the source files unless you need to modify them. You would then modify the corresponding {\ttfamily .pump} files and run the \textquotesingle{}\href{googletest/scripts/pump.py}{\texttt{ pump.\+py}}\textquotesingle{} generator script. See the Pump Manual.\hypertarget{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1256}{}\doxysubsection{Contributing Code}\label{md_vendor_googletest__r_e_a_d_m_e_autotoc_md1256}
