...
{\bfseries{Note\+:}} Google \mbox{\hyperlink{class_mock}{Mock}} lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by Google \mbox{\hyperlink{class_mock}{Mock}}. We omit such {\ttfamily using} statements in this page for brevity, but you should do it in your own code.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md229}{}\doxysection{Creating Mock Classes}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md229}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md230}{}\doxysubsection{Mocking Private or Protected Methods}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md230}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md231}{}\doxysubsection{Mocking Overloaded Methods}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md231}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md232}{}\doxysubsection{Mocking Class Templates}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md232}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md233}{}\doxysubsection{Mocking Nonvirtual Methods}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md233}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md234}{}\doxysubsection{Mocking Free Functions}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md234}
...
By defining a new mock method with a trimmed argument list, we make the mock class much more user-\/friendly.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md237}{}\doxysubsection{Alternative to Mocking Concrete Classes}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md237}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md238}{}\doxysubsection{Delegating Calls to a Fake}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md238}
...
Instead, you can define a {\ttfamily File\+Ops} interface and an {\ttfamily I\+O\+Ops} interface and split {\ttfamily System}\textquotesingle{}s functionalities into the two. Then you can mock {\ttfamily I\+O\+Ops} without mocking {\ttfamily File\+Ops}.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md239}{}\doxysubsection{Delegating Calls to a Real Object}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md239}
...
(Why don\textquotesingle{}t we just write {\ttfamily Invoke(\&foo, \&\+Foo\+::\+Concrete)}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md241}{}\doxysection{Using Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md241}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md242}{}\doxysubsection{Matching Argument Values Exactly}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md242}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md243}{}\doxysubsection{Using Simple Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md243}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md244}{}\doxysubsection{Combining Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md244}
...
\DoxyCodeLine{                          NULL));}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md245}{}\doxysubsection{Casting Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md245}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md246}{}\doxysubsection{Selecting Between Overloaded Functions}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md246}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md247}{}\doxysubsection{Performing Different Actions Based on the Arguments}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md247}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md248}{}\doxysubsection{Matching Multiple Arguments as a Whole}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md248}
...
As a convenience and example, Google \mbox{\hyperlink{class_mock}{Mock}} provides some matchers for 2-\/tuples, including the {\ttfamily Lt()} matcher above. See the Cheat\+Sheet for the complete list.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md249}{}\doxysubsection{Using Matchers as Predicates}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md249}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md250}{}\doxysubsection{Using Matchers in Google Test Assertions}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md250}
...
{\bfseries{Credit\+:}} The idea of {\ttfamily (A\+S\+S\+E\+R\+T$\vert$\+E\+X\+P\+E\+CT)\+\_\+\+T\+H\+AT} was stolen from the \href{http://code.google.com/p/hamcrest/}{\texttt{ Hamcrest}} project, which adds {\ttfamily assert\+That()} to J\+Unit.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md251}{}\doxysubsection{Using Predicates as Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md251}
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in statement {\ttfamily if (condition) ...}.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md252}{}\doxysubsection{Matching Arguments that Are Not Copyable}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md252}
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}, or the result is undefined.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md253}{}\doxysubsection{Validating a Member of an Object}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md253}
...
What if you want to validate more than one members at the same time? Remember that there is {\ttfamily All\+Of()}.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md254}{}\doxysubsection{Validating the Value Pointed to by a Pointer Argument}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md254}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md255}{}\doxysubsection{Testing a Certain Property of an Object}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md255}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md256}{}\doxysubsection{Matching Containers}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md256}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md257}{}\doxysubsection{Sharing Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md257}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md258}{}\doxysection{Setting Expectations}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md258}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md259}{}\doxysubsection{Ignoring Uninteresting Calls}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md259}
...
Please note that once you expressed interest in a particular mock method (via {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} statement, it will be an error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md260}{}\doxysubsection{Disallowing Unexpected Calls}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md260}
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} statements will be an error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md261}{}\doxysubsection{Expecting Ordered Calls}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md261}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, Google \mbox{\hyperlink{class_mock}{Mock}} will report an error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md262}{}\doxysubsection{Expecting Partially Ordered Calls}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md262}
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md263}{}\doxysubsection{Controlling When an Expectation Retires}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md263}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily \char`\"{}\+File too large.\char`\"{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md264}{}\doxysection{Using Actions}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md264}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md265}{}\doxysubsection{Returning References from Mock Methods}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md265}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md266}{}\doxysubsection{Combining Actions}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md266}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md267}{}\doxysubsection{Mocking Side Effects}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md267}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md268}{}\doxysubsection{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md268}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md269}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md269}
...
Please note that changing the default value for a type can make you tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md270}{}\doxysubsection{Setting the Default Actions for a Mock Method}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md270}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md273}{}\doxysubsection{Invoking an Argument of the Mock Function}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md273}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md274}{}\doxysubsection{Ignoring an Action\textquotesingle{}s Result}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md274}
...
Note that you {\bfseries{cannot}} use {\ttfamily Ignore\+Result()} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md275}{}\doxysubsection{Selecting an Action\textquotesingle{}s Arguments}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md275}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md276}{}\doxysubsection{Ignoring Arguments in Action Functions}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md276}
...
\DoxyCodeLine{      .WillOnce(Invoke(DistanceToOrigin));}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md277}{}\doxysubsection{Sharing Actions}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md277}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md278}{}\doxysection{Misc Recipes on Using Google Mock}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md278}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md279}{}\doxysubsection{Forcing a Verification}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md279}
...
{\bfseries{Tip\+:}} The {\ttfamily Mock\+::\+Verify\+And\+Clear\+Expectations()} function returns a {\ttfamily bool} to indicate whether the verification was successful ({\ttfamily true} for yes), so you can wrap that function call inside a {\ttfamily A\+S\+S\+E\+R\+T\+\_\+\+T\+R\+U\+E()} if there is no point going further when the verification has failed.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md280}{}\doxysubsection{Using Check Points}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md280}
...
And that\textquotesingle{}s that.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md282}{}\doxysubsection{Using Google Mock and Threads}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md282}
...
Also, remember that {\ttfamily Default\+Value$<$T$>$} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md283}{}\doxysubsection{Controlling How Much Information Google Mock Prints}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md283}
...
Now, judiciously use the right flag to enable Google \mbox{\hyperlink{class_mock}{Mock}} serve you better!\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md284}{}\doxysubsection{Running Tests in Emacs}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md284}
...
Then you can type {\ttfamily M-\/m} to start a build, or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md285}{}\doxysubsection{Fusing Google Mock Source Files}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md285}
...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md288}{}\doxysubsection{Writing New Parameterized Matchers Quickly}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md288}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md290}{}\doxysubsection{Writing New Polymorphic Matchers}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md290}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md291}{}\doxysubsection{Writing New Cardinalities}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md291}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md292}{}\doxysubsection{Writing New Actions Quickly}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md292}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md293}{}\doxysubsection{Writing New Parameterized Actions Quickly}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md293}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md294}{}\doxysubsection{Restricting the Type of an Argument or Parameter in an A\+C\+T\+I\+ON}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md294}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in Google Test that verifies two types are the same.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md295}{}\doxysubsection{Writing New Action Templates Quickly}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md295}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md296}{}\doxysubsection{Using the A\+C\+T\+I\+O\+N Object\textquotesingle{}s Type}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md296}
...
Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md297}{}\doxysubsection{Writing New Monomorphic Actions}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md297}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md298}{}\doxysubsection{Writing New Polymorphic Actions}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md298}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md299}{}\doxysubsection{Teaching Google Mock How to Print Your Values}\label{md_vendor_googletest_googlemock_docs_v1_5__cook_book_autotoc_md299}
