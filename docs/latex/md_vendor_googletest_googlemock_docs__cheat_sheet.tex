\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md10}{}\doxysection{Mocking a Normal Class}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md10}
Given 
\begin{DoxyCode}{0}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md11}{}\doxysection{Mocking a Class Template}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md11}
To mock 
\begin{DoxyCode}{0}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md12}{}\doxysection{Specifying Calling Conventions for Mock Functions}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md12}
...
where {\ttfamily S\+T\+D\+M\+E\+T\+H\+O\+D\+C\+A\+L\+L\+T\+Y\+PE} is defined by {\ttfamily $<$objbase.\+h$>$} on Windows.\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md13}{}\doxysection{Using Mocks in Tests}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md13}
The typical flow is\+:
\begin{DoxyEnumerate}
...
\DoxyCodeLine{\}                                                 // \#6}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md14}{}\doxysection{Setting Default Actions}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md14}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md15}{}\doxysection{Setting Expectations}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md15}
...
A method with no {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} is free to be invoked {\itshape any number of times}, and the default action will be taken each time.\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md16}{}\doxysection{Matchers}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md16}
...
Built-\/in matchers (where {\ttfamily argument} is the function argument) are divided into several categories\+:\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md17}{}\doxysubsection{Wildcard}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md17}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md18}{}\doxysubsection{Generic Comparison}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md18}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md20}{}\doxysubsection{String Matchers}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md20}
...
{\ttfamily Contains\+Regex()} and {\ttfamily Matches\+Regex()} use the regular expression syntax defined \href{../../googletest/docs/AdvancedGuide.md\#regular-expression-syntax}{\texttt{ here}}. {\ttfamily Str\+Case\+Eq()}, {\ttfamily Str\+Case\+Ne()}, {\ttfamily Str\+Eq()}, and {\ttfamily Str\+Ne()} work for wide strings as well.\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md21}{}\doxysubsection{Container Matchers}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md21}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md22}{}\doxysubsection{Member Matchers}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md22}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md23}{}\doxysubsection{Matching the Result of a Function or Functor}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md23}
$\vert${\ttfamily Result\+Of(f, m)}$\vert${\ttfamily f(argument)} matches matcher {\ttfamily m}, where {\ttfamily f} is a function or functor.$\vert$ $\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\+:-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/---$\vert$\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md24}{}\doxysubsection{Pointer Matchers}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md24}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md25}{}\doxysubsection{Multiargument Matchers}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md25}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md26}{}\doxysubsection{Composite Matchers}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md26}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md27}{}\doxysubsection{Adapters for Matchers}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md27}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md28}{}\doxysubsection{Matchers as Predicates}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md28}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md29}{}\doxysubsection{Defining Matchers}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md29}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md30}{}\doxysubsection{Matchers as Test Assertions}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md30}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md31}{}\doxysection{Actions}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md31}
{\bfseries{Actions}} specify what a mock function should do when invoked.\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md32}{}\doxysubsection{Returning a Value}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md32}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md33}{}\doxysubsection{Side Effects}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md33}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md34}{}\doxysubsection{Using a Function or a Functor as an Action}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md34}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md35}{}\doxysubsection{Default Action}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md35}
...
{\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md36}{}\doxysubsection{Composite Actions}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md36}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md37}{}\doxysubsection{Defining Actions}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md37}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
...
The {\ttfamily A\+C\+T\+I\+O\+N$\ast$} macros cannot be used inside a function or class.\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md38}{}\doxysection{Cardinalities}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md38}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md39}{}\doxysection{Expectation Order}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md39}
By default, the expectations can be matched in {\itshape any} order. If some or all expectations must be matched in a given order, there are two ways to specify it. They can be used either independently or together.\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md40}{}\doxysubsection{The After Clause}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md40}
...
says that all expected calls in the scope of {\ttfamily dummy} must occur in strict order. The name {\ttfamily dummy} is irrelevant.)\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md42}{}\doxysection{Verifying and Resetting a Mock}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md42}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md43}{}\doxysection{Mock Classes}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md43}
...
See this \href{CookBook.md\#using-check-points}{\texttt{ recipe}} for one application of it.\hypertarget{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md44}{}\doxysection{Flags}\label{md_vendor_googletest_googlemock_docs__cheat_sheet_autotoc_md44}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
