The Google C++ mocking framework.\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md640}{}\doxysubsection{Overview}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md640}
...
We hope you find it useful!\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md641}{}\doxysubsection{Features}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md641}
...
If you need help, please check the Known\+Issues and Frequently\+Asked\+Questions before posting a question on the \href{http://groups.google.com/group/googlemock}{\texttt{ discussion group}}.\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md643}{}\doxysubsection{Using Google Mock Without Google Test}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md643}
Google \mbox{\hyperlink{class_mock}{Mock}} is not a testing framework itself. Instead, it needs a testing framework for writing tests. Google \mbox{\hyperlink{class_mock}{Mock}} works seamlessly with \href{http://code.google.com/p/googletest/}{\texttt{ Google Test}}, but you can also use it with \href{googlemock/ForDummies.md\#Using_Google_Mock_with_Any_Testing_Framework}{\texttt{ any C++ testing framework}}.\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md644}{}\doxysubsection{Requirements for End Users}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md644}
...
Google \mbox{\hyperlink{class_mock}{Mock}} depends on advanced C++ features and thus requires a more modern compiler. The following are needed to use Google \mbox{\hyperlink{class_mock}{Mock}}\+:\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md645}{}\doxysubsubsection{Linux Requirements}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md645}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md646}{}\doxysubsubsection{Windows Requirements}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md646}

\begin{DoxyItemize}
\item Microsoft Visual C++ 8.\+0 S\+P1 or newer
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md647}{}\doxysubsubsection{Mac O\+S X Requirements}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md647}

\begin{DoxyItemize}
\item Mac OS X 10.\+4 Tiger or newer
\item Developer Tools Installed
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md648}{}\doxysubsection{Requirements for Contributors}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md648}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md649}{}\doxysubsection{Building Google Mock}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md649}
\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md650}{}\doxysubsubsection{Preparing to Build (\+Unix only)}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md650}
...
If you see errors, try to tweak the contents of \href{make/Makefile}{\texttt{ make/\+Makefile}} to make them go away.\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md651}{}\doxysubsection{Windows}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md651}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md652}{}\doxysubsection{Tweaking Google Mock}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md652}
...
We list the most frequently used macros below. For a complete list, see file \href{../googletest/include/gtest/internal/gtest-port.h}{\texttt{ \$\{G\+T\+E\+S\+T\+\_\+\+D\+IR\}/include/gtest/internal/gtest-\/port.h}}.\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md653}{}\doxysubsection{Choosing a T\+R1 Tuple Library}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md653}
...
If you want to use Boost\textquotesingle{}s T\+R1 tuple library with Google \mbox{\hyperlink{class_mock}{Mock}}, please refer to the Boost website (\href{http://www.boost.org/}{\texttt{ http\+://www.\+boost.\+org/}}) for how to obtain it and set it up.\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md654}{}\doxysubsection{As a Shared Library (\+D\+L\+L)}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md654}
Google \mbox{\hyperlink{class_mock}{Mock}} is compact, so most users can build and link it as a static library for the simplicity. Google \mbox{\hyperlink{class_mock}{Mock}} can be used as a D\+LL, but the same D\+LL must contain Google Test as well. See ../googletest/\+R\+E\+A\+D\+ME.md \char`\"{}\+Google Test\textquotesingle{}s R\+E\+A\+D\+M\+E\char`\"{} for instructions on how to set up necessary compiler settings.\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md655}{}\doxysubsection{Tweaking Google Mock}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md655}
Most of Google Test\textquotesingle{}s control macros apply to Google \mbox{\hyperlink{class_mock}{Mock}} as well. Please see ../googletest/\+R\+E\+A\+D\+ME.md \char`\"{}\+Google Test\textquotesingle{}s R\+E\+A\+D\+M\+E\char`\"{} for how to tweak them.\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md656}{}\doxysubsection{Upgrading from an Earlier Version}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md656}
We strive to keep Google \mbox{\hyperlink{class_mock}{Mock}} releases backward compatible. Sometimes, though, we have to make some breaking changes for the users\textquotesingle{} long-\/term benefits. This section describes what you\textquotesingle{}ll need to do if you are upgrading from an earlier version of Google \mbox{\hyperlink{class_mock}{Mock}}.\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md657}{}\doxysubsubsection{Upgrading from 1.\+1.\+0 or Earlier}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md657}
...
\+Library\mbox{]}(../googletest/\#choosing-\/a-\/tr1-\/tuple-\/library)\char`\"{}.\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md658}{}\doxysubsubsection{Upgrading from 1.\+4.\+0 or Earlier}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md658}
...
If you have custom matchers defined using {\ttfamily Matcher\+Interface} or {\ttfamily Make\+Polymorphic\+Matcher()}, you\textquotesingle{}ll need to update their definitions to use the new matcher A\+PI ( \href{http://code.google.com/p/googlemock/wiki/CookBook\#Writing_New_Monomorphic_Matchers}{\texttt{ monomorphic}}, \href{http://code.google.com/p/googlemock/wiki/CookBook\#Writing_New_Polymorphic_Matchers}{\texttt{ polymorphic}}). Matchers defined using {\ttfamily M\+A\+T\+C\+H\+E\+R()} or {\ttfamily M\+A\+T\+C\+H\+E\+R\+\_\+\+P$\ast$()} aren\textquotesingle{}t affected.\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md659}{}\doxysubsection{Developing Google Mock}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md659}
This section discusses how to make your own changes to Google \mbox{\hyperlink{class_mock}{Mock}}.\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md660}{}\doxysubsubsection{Testing Google Mock Itself}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md660}
...
Note that when building your project against Google \mbox{\hyperlink{class_mock}{Mock}}, you are building against Google Test as well. There is no need to configure Google Test separately.\hypertarget{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md661}{}\doxysubsubsection{Contributing a Patch}\label{md_vendor_googletest_googlemock__r_e_a_d_m_e_autotoc_md661}
