...
{\itshape Note\+:} We sometimes refer to Google C++ Testing Framework informally as {\itshape Google Test}.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1195}{}\doxysection{Setting up a New Test Project}\label{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1195}
...
If you still have questions, take a look at how Google Test\textquotesingle{}s own tests are built and use them as examples.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1196}{}\doxysection{Basic Concepts}\label{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1196}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test cases.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1197}{}\doxysection{Assertions}\label{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1197}
...
Anything that can be streamed to an {\ttfamily ostream} can be streamed to an assertion macro--in particular, C strings and {\ttfamily string} objects. If a wide string ({\ttfamily wchar\+\_\+t$\ast$}, {\ttfamily T\+C\+H\+A\+R$\ast$} in {\ttfamily U\+N\+I\+C\+O\+DE} mode on Windows, or {\ttfamily std\+::wstring}) is streamed to an assertion, it will be translated to U\+T\+F-\/8 when printed.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1198}{}\doxysubsection{Basic Assertions}\label{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1198}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1199}{}\doxysubsection{Binary Comparison}\label{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1199}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1200}{}\doxysubsection{String Comparison}\label{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1200}
...
See also\+: For more string comparison tricks (substring, prefix, suffix, and regular expression matching, for example), see the Advanced Google Test Guide.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1201}{}\doxysection{Simple Tests}\label{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1201}
To create a test\+:
\begin{DoxyEnumerate}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1202}{}\doxysection{Test Fixtures\+: Using the Same Data Configuration for Multiple Tests}\label{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1202}
...
{\itshape Note}\+: Google Test automatically saves all {\itshape Google Test} flags when a test object is constructed, and restores them when it is destructed.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1203}{}\doxysection{Invoking the Tests}\label{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1203}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1204}{}\doxysection{Writing the main() Function}\label{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1204}
...
But maybe you think that writing all those main() functions is too much work? We agree with you completely and that\textquotesingle{}s why Google Test provides a basic implementation of main(). If it fits your needs, then just link your test with gtest\+\_\+main library and you are good to go.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1205}{}\doxysubsection{Important note for Visual C++ users}\label{md_vendor_googletest_googletest_docs__v1_7__primer_autotoc_md1205}
