{\bfseries{P}}ump is {\bfseries{U}}seful for {\bfseries{M}}eta {\bfseries{P}}rogramming.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__pump_manual_autotoc_md928}{}\doxysection{The Problem}\label{md_vendor_googletest_googletest_docs__v1_5__pump_manual_autotoc_md928}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_5__pump_manual_autotoc_md931}{}\doxysubsection{Examples}\label{md_vendor_googletest_googletest_docs__v1_5__pump_manual_autotoc_md931}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_5__pump_manual_autotoc_md932}{}\doxysubsection{Constructs}\label{md_vendor_googletest_googletest_docs__v1_5__pump_manual_autotoc_md932}
...
{\bfseries{Note\+:}} To give the user some freedom in formatting the Pump source code, Pump ignores a new-\/line character if it\textquotesingle{}s right after {\ttfamily \$for foo} or next to {\ttfamily \mbox{[}\mbox{[}} or {\ttfamily \mbox{]}\mbox{]}}. Without this rule you\textquotesingle{}ll often be forced to write very long lines to get the desired output. Therefore sometimes you may need to insert an extra new-\/line in such places for a new-\/line to show up in your output.\hypertarget{md_vendor_googletest_googletest_docs__v1_5__pump_manual_autotoc_md933}{}\doxysubsection{Grammar}\label{md_vendor_googletest_googletest_docs__v1_5__pump_manual_autotoc_md933}
