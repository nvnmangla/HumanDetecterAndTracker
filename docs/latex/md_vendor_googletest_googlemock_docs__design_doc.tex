This page discusses the design of new Google \mbox{\hyperlink{class_mock}{Mock}} features.\hypertarget{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md122}{}\doxysection{Macros for Defining Actions}\label{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md122}
\hypertarget{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md123}{}\doxysubsection{Problem}\label{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md123}
...
Our goal is to allow defining custom actions with the least amount of boiler-\/plate C++ requires.\hypertarget{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md124}{}\doxysubsection{Solution}\label{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md124}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md125}{}\doxysubsection{Parameterized actions}\label{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md125}
...
You can view {\ttfamily A\+C\+T\+I\+ON} as a degenerated parameterized action where the number of parameters is 0.\hypertarget{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md126}{}\doxysubsection{Advanced Usages}\label{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md126}
\hypertarget{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md127}{}\doxysubsubsection{Overloading Actions}\label{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md127}
You can easily define actions overloaded on the number of parameters\+: 
\begin{DoxyCode}{0}
\DoxyCodeLine{ACTION\_P(Plus, a) \{ ... \}}
\DoxyCodeLine{ACTION\_P2(Plus, a, b) \{ ... \}}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md128}{}\doxysubsubsection{Restricting the Type of an Argument or Parameter}\label{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md128}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion we plan to add to Google Test (the name is chosen to match {\ttfamily static\+\_\+assert} in C++0x).\hypertarget{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md129}{}\doxysubsubsection{Using the A\+C\+T\+I\+O\+N Object\textquotesingle{}s Type}\label{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md129}
...
{\ttfamily A\+C\+T\+I\+O\+N$\ast$} avoid all these problems.\hypertarget{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md132}{}\doxysubsection{Future Improvements}\label{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md132}
...
C++0x will also support lambda expressions. When they become available, we may want to support using lambdas as actions.\hypertarget{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md133}{}\doxysection{Macros for Defining Matchers}\label{md_vendor_googletest_googlemock_docs__design_doc_autotoc_md133}
