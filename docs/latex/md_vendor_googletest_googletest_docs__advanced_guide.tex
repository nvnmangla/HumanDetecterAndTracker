Now that you have read Primer and learned how to write tests using Google Test, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md663}{}\doxysection{More Assertions}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md663}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md664}{}\doxysubsection{Explicit Success and Failure}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md664}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md665}{}\doxysubsection{Exception Assertions}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md665}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md666}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md666}
...
Google Test gives you three different options to solve this problem\+:\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md667}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md667}
...
{\itshape Availability}\+: Linux, Windows, Mac\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md668}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md668}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+4.\+1.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md669}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md669}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md670}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md670}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md672}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md672}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md673}{}\doxysubsection{Windows H\+R\+E\+S\+U\+L\+T assertions}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md673}
...
{\itshape Availability}\+: Windows.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md674}{}\doxysubsection{Type Assertions}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md674}
...
{\itshape Availability\+:} Linux, Windows, Mac; since version 1.\+3.\+0.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md675}{}\doxysubsection{Assertion Placement}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md675}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md677}{}\doxysection{Death Tests}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md677}
...
If you want to test {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$()/\+A\+S\+S\+E\+R\+T\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ Catching Failures}}.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md678}{}\doxysubsection{How to Write a Death Test}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md678}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Cygwin, and Mac (the latter three are supported since v1.\+3.\+0). {\ttfamily (A\+S\+S\+E\+R\+T$\vert$\+E\+X\+P\+E\+CT)\+\_\+\+D\+E\+A\+T\+H\+\_\+\+I\+F\+\_\+\+S\+U\+P\+P\+O\+R\+T\+ED} are new in v1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md679}{}\doxysubsection{Regular Expression Syntax}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md679}
...
If the death test statement runs to completion without dying, the child process will nonetheless terminate, and the assertion fails.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md681}{}\doxysubsection{Death Tests And Threads}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md681}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md682}{}\doxysubsection{Death Test Styles}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md682}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md683}{}\doxysubsection{Caveats}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md683}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md684}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md684}
\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md685}{}\doxysubsection{Adding Traces to Assertions}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md685}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md686}{}\doxysubsection{Propagating Fatal Failures}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md686}
...
{\itshape Availability\+:} Linux, Windows, Mac. Assertions from multiple threads are currently not supported.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md688}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md688}
...
{\itshape Availability\+:} Linux, Windows, Mac. {\ttfamily Has\+Nonfatal\+Failure()} and {\ttfamily Has\+Failure()} are available since version 1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md689}{}\doxysection{Logging Additional Information}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md689}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md690}{}\doxysection{Sharing Resources Between Tests in the Same Test Case}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md690}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md691}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md691}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md692}{}\doxysection{Value Parameterized Tests}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md692}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md693}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md693}
...
{\itshape Availability}\+: Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+2.\+0.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md694}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md694}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily I\+N\+S\+T\+A\+N\+T\+I\+A\+T\+E\+\_\+\+T\+E\+S\+T\+\_\+\+C\+A\+S\+E\+\_\+\+P()}, and linking with {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test case multiple times, possibly in different source files.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md695}{}\doxysection{Typed Tests}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md695}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md696}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md696}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md697}{}\doxysection{Testing Private Code}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md697}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md698}{}\doxysubsection{Static Functions}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md698}
...
However, a better approach is to move the private code into the {\ttfamily foo\+::internal} namespace, where {\ttfamily foo} is the namespace your project normally uses, and put the private declarations in a {\ttfamily $\ast$-\/internal.h} file. Your production {\ttfamily .cc} files and your tests are allowed to include this internal header, but your clients are not. This way, you can fully test your internal implementation without leaking it to your clients.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md699}{}\doxysubsection{Private Class Members}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md699}
...
\DoxyCodeLine{\}  // namespace my\_namespace}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md700}{}\doxysection{Catching Failures}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md700}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md701}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md701}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md702}{}\doxysection{Extending Google Test by Handling Test Events}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md702}
...
{\itshape Availability\+:} Linux, Windows, Mac; since v1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md703}{}\doxysubsection{Defining Event Listeners}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md703}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md704}{}\doxysubsection{Using Event Listeners}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md704}
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default X\+ML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md705}{}\doxysubsection{Generating Failures in Listeners}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md705}
...
We have a sample of failure-\/raising listener \href{../samples/sample10_unittest.cc}{\texttt{ here}}.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md706}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md706}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md707}{}\doxysubsection{Selecting Tests}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md707}
This section shows various options for choosing which tests to run.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md708}{}\doxysubsubsection{Listing Test Names}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md708}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md709}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md709}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md710}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md710}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md711}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md711}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md712}{}\doxysubsection{Repeating the Tests}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md712}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md713}{}\doxysubsection{Shuffling the Tests}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md713}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md714}{}\doxysubsection{Controlling Test Output}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md714}
{\itshape  This section teaches how to tweak the way test results are reported.}

{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md715}{}\doxysubsubsection{Colored Terminal Output}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md715}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md716}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md716}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md717}{}\doxysubsubsection{Generating an X\+M\+L Report}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md717}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md718}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md718}
{\itshape  }\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md719}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md719}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md720}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md720}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md721}{}\doxysubsubsection{Letting Another Testing Framework Drive}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md721}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md722}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md722}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md723}{}\doxysection{Fusing Google Test Source Files}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md723}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md724}{}\doxysection{Where to Go from Here}\label{md_vendor_googletest_googletest_docs__advanced_guide_autotoc_md724}
