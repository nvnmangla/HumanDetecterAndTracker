Now that you have read Primer and learned how to write tests using Google Test, it\textquotesingle{}s time to learn some new tricks. This document will show you more assertions as well as how to construct complex failure messages, propagate fatal failures, reuse and speed up your test fixtures, and use various flags with your tests.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md944}{}\doxysection{More Assertions}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md944}
This section covers some less frequently used, but still significant, assertions.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md945}{}\doxysubsection{Explicit Success and Failure}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md945}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md946}{}\doxysubsection{Exception Assertions}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md946}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md947}{}\doxysubsection{Predicate Assertions for Better Error Messages}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md947}
...
Google Test gives you three different options to solve this problem\+:\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md948}{}\doxysubsubsection{Using an Existing Boolean Function}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md948}
...
{\itshape Availability}\+: Linux, Windows, Mac\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md949}{}\doxysubsubsection{Using a Function That Returns an Assertion\+Result}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md949}
...
{\itshape Availability}\+: Linux, Windows, Mac; since version 1.\+4.\+1.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md950}{}\doxysubsubsection{Using a Predicate-\/\+Formatter}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md950}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md951}{}\doxysubsection{Floating-\/\+Point Comparison}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md951}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md953}{}\doxysubsubsection{Floating-\/\+Point Predicate-\/\+Format Functions}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md953}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md954}{}\doxysubsection{Windows H\+R\+E\+S\+U\+L\+T assertions}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md954}
...
{\itshape Availability}\+: Windows.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md955}{}\doxysubsection{Type Assertions}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md955}
...
{\itshape Availability\+:} Linux, Windows, Mac; since version 1.\+3.\+0.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md956}{}\doxysubsection{Assertion Placement}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md956}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md958}{}\doxysection{Death Tests}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md958}
...
If you want to test {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$()/\+A\+S\+S\+E\+R\+T\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ Catching Failures}}.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md959}{}\doxysubsection{How to Write a Death Test}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md959}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Cygwin, and Mac (the latter three are supported since v1.\+3.\+0). {\ttfamily (A\+S\+S\+E\+R\+T$\vert$\+E\+X\+P\+E\+CT)\+\_\+\+D\+E\+A\+T\+H\+\_\+\+I\+F\+\_\+\+S\+U\+P\+P\+O\+R\+T\+ED} are new in v1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md960}{}\doxysubsection{Regular Expression Syntax}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md960}
...
If the death test statement runs to completion without dying, the child process will nonetheless terminate, and the assertion fails.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md962}{}\doxysubsection{Death Tests And Threads}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md962}
...
It\textquotesingle{}s perfectly fine to create threads inside a death test statement; they are executed in a separate process and cannot affect the parent.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md963}{}\doxysubsection{Death Test Styles}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md963}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md964}{}\doxysubsection{Caveats}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md964}
...
Despite the improved thread safety afforded by the \char`\"{}threadsafe\char`\"{} style of death test, thread problems such as deadlock are still possible in the presence of handlers registered with {\ttfamily pthread\+\_\+atfork(3)}.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md965}{}\doxysection{Using Assertions in Sub-\/routines}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md965}
\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md966}{}\doxysubsection{Adding Traces to Assertions}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md966}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md967}{}\doxysubsection{Propagating Fatal Failures}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md967}
...
{\itshape Availability\+:} Linux, Windows, Mac. Assertions from multiple threads are currently not supported.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md969}{}\doxysubsubsection{Checking for Failures in the Current Test}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md969}
...
{\itshape Availability\+:} Linux, Windows, Mac. {\ttfamily Has\+Nonfatal\+Failure()} and {\ttfamily Has\+Failure()} are available since version 1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md970}{}\doxysection{Logging Additional Information}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md970}
...
{\itshape Availability}\+: Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md971}{}\doxysection{Sharing Resources Between Tests in the Same Test Case}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md971}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md972}{}\doxysection{Global Set-\/\+Up and Tear-\/\+Down}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md972}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md973}{}\doxysection{Value Parameterized Tests}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md973}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md974}{}\doxysubsection{How to Write Value-\/\+Parameterized Tests}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md974}
...
{\itshape Availability}\+: Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+2.\+0.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md975}{}\doxysubsection{Creating Value-\/\+Parameterized Abstract Tests}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md975}
...
Once they are defined, you can instantiate them by including {\ttfamily foo\+\_\+param\+\_\+test.\+h}, invoking {\ttfamily I\+N\+S\+T\+A\+N\+T\+I\+A\+T\+E\+\_\+\+T\+E\+S\+T\+\_\+\+C\+A\+S\+E\+\_\+\+P()}, and linking with {\ttfamily foo\+\_\+param\+\_\+test.\+cc}. You can instantiate the same abstract test case multiple times, possibly in different source files.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md976}{}\doxysection{Typed Tests}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md976}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md977}{}\doxysection{Type-\/\+Parameterized Tests}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md977}
...
{\itshape Availability\+:} Linux, Windows (requires M\+S\+VC 8.\+0 or above), Mac; since version 1.\+1.\+0.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md978}{}\doxysection{Testing Private Code}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md978}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md979}{}\doxysubsection{Static Functions}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md979}
...
However, a better approach is to move the private code into the {\ttfamily foo\+::internal} namespace, where {\ttfamily foo} is the namespace your project normally uses, and put the private declarations in a {\ttfamily $\ast$-\/internal.h} file. Your production {\ttfamily .cc} files and your tests are allowed to include this internal header, but your clients are not. This way, you can fully test your internal implementation without leaking it to your clients.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md980}{}\doxysubsection{Private Class Members}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md980}
...
\DoxyCodeLine{\}  // namespace my\_namespace}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md981}{}\doxysection{Catching Failures}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md981}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md982}{}\doxysection{Getting the Current Test\textquotesingle{}s Name}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md982}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md983}{}\doxysection{Extending Google Test by Handling Test Events}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md983}
...
{\itshape Availability\+:} Linux, Windows, Mac; since v1.\+4.\+0.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md984}{}\doxysubsection{Defining Event Listeners}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md984}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md985}{}\doxysubsection{Using Event Listeners}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md985}
...
You may append more than one listener to the list. When an {\ttfamily On$\ast$\+Start()} or {\ttfamily On\+Test\+Part\+Result()} event is fired, the listeners will receive it in the order they appear in the list (since new listeners are added to the end of the list, the default text printer and the default X\+ML generator will receive the event first). An {\ttfamily On$\ast$\+End()} event will be received by the listeners in the {\itshape reverse} order. This allows output by listeners added later to be framed by output from listeners added earlier.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md986}{}\doxysubsection{Generating Failures in Listeners}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md986}
...
We have a sample of failure-\/raising listener \href{../samples/sample10_unittest.cc}{\texttt{ here}}.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md987}{}\doxysection{Running Test Programs\+: Advanced Options}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md987}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md988}{}\doxysubsection{Selecting Tests}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md988}
This section shows various options for choosing which tests to run.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md989}{}\doxysubsubsection{Listing Test Names}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md989}
...
{\itshape Availability\+:} Linux, Windows, Mac.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md990}{}\doxysubsubsection{Running a Subset of the Tests}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md990}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md991}{}\doxysubsubsection{Temporarily Disabling Tests}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md991}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md992}{}\doxysubsubsection{Temporarily Enabling Disabled Tests}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md992}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md993}{}\doxysubsection{Repeating the Tests}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md993}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md994}{}\doxysubsection{Shuffling the Tests}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md994}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md995}{}\doxysubsection{Controlling Test Output}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md995}
{\itshape  This section teaches how to tweak the way test results are reported.}

{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md996}{}\doxysubsubsection{Colored Terminal Output}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md996}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md997}{}\doxysubsubsection{Suppressing the Elapsed Time}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md997}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md998}{}\doxysubsubsection{Generating an X\+M\+L Report}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md998}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md999}{}\doxysubsection{Controlling How Failures Are Reported}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md999}
{\itshape  }\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md1000}{}\doxysubsubsection{Turning Assertion Failures into Break-\/\+Points}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md1000}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md1001}{}\doxysubsubsection{Disabling Catching Test-\/\+Thrown Exceptions}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md1001}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md1002}{}\doxysubsubsection{Letting Another Testing Framework Drive}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md1002}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md1003}{}\doxysubsection{Distributing Test Functions to Multiple Machines}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md1003}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md1004}{}\doxysection{Fusing Google Test Source Files}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md1004}
...
{\itshape }\hypertarget{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md1005}{}\doxysection{Where to Go from Here}\label{md_vendor_googletest_googletest_docs__v1_6__advanced_guide_autotoc_md1005}
